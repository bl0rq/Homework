...
namespace Waitlist.UI.Core.ViewModel
{
    public class WaitlistMain : Utilis.UI.ViewModel.Base
    {
        ...
        public WaitlistMain ( )
        {
            ...
            m_svcWaitlist = new Service.Waitlist ( new Utility.XmlFilePersister ( System.IO.Path.Combine ( Environment.GetFolderPath ( Environment.SpecialFolder.ApplicationData ), "Waitlist.Waitlist" ) ) );
